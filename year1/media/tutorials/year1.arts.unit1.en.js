...
undum.game.situations = {
    ...
    todo: new undum.SimpleSituation(
        "<p><a href='/media/tutorials/' class='sticky'>Download Worksheet 1.1</a>and complete the required assignment. <a href='./worksheet1.1.pdf'>Done assignment!</a>.\
        <p class='transient'>Make sure student has carried out the action above. Including clicking [Done assignment!],\
        then <a href='hub'>return to the module list</a>.</p>",
        {
            actions: {
                'worksheet1-1': "<p>You carried out Take Home Worksheet 1.1. Well done!</p>"
            }
        }
    ),
    ...
    "boost-stamina": new undum.SimpleSituation(
        ...
        \
        <p>Let's <a href='hub'>return to the module list.</a></p>"
        ),
